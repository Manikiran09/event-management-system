...
If `VITE_API_BASE_URL` is not set, the frontend will automatically try `https://angelic-laughter-production-163d.up.railway.app/api` before showing the **Set API URL** action on the login screen.

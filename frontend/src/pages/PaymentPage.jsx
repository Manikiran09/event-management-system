                ...
                {paymentMethod === "upi" ? (
                  <div className="grid gap-5 md:grid-cols-[220px_1fr] md:items-center">
                    <div className="rounded-2xl bg-white p-4 shadow-sm">
                      <QRCode value={upiPayload} size={180} className="h-auto w-full" />
                    </div>
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-6 text-slate-600">Open any UPI app and scan the QR. After payment, enter the transaction reference to finish registration.</p>

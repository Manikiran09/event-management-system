...
const RegisterPage = () => {
  ...
  return (
    <main className="grid min-h-screen place-items-center px-4 py-6 md:py-8">
      <section className="grid w-full max-w-[1120px] overflow-hidden rounded-[2rem] border border-white/50 bg-white/35 shadow-glow backdrop-blur-2xl lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <section className="w-full rounded-none border-0 bg-white/85 p-6 md:p-8 lg:rounded-r-[2rem] xl:p-10">
          <div className="mb-8">
